...
//     let urlArray = ["https://fanjoy.co/products.json?" + query, "https://gymshark.com/products.json?" + query];
...
//                 csv_date.toDisk("./products_by_date.csv");
//                 const csv_type = new ObjectsToCsv(groupedProductsbyType);
//                 csv_type.toDisk("./products_by_type.csv");
